...
app.use(express.urlencoded({ extended:false })); // middleware for formdata as bby default submitting form sens url encoded data.
...
app.get("/template",(req,res)=>{
    ...
    // const localVariable="Sonmething in here";  // from anywhere // it can be from database
...
app.delete("/delete/:id", (req, res) => {
    ...
    data = data.filter(ele => ele._id != id); // it will filter out all the records except that we re deleting.
